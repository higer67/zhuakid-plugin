...
item = {
    ...
    [
        1000,
        4,
        '现在加工器收费了......因此这个道具可以永久使用。\n使用加工器可以花费一段时间将你的刺儿加工成一个精美的小饰品，一个小饰品的原料要190刺儿，耗时约2小时15分钟，小饰品可以卖到一个不菲的价钱。\n 输入/use 刺儿加工器/数量 来确定你本次要加工多少个饰品。请确保你的原料数量充足，并且加工饰品数量越多，所需时间越长。'
    ],
    '刺儿饰品':
    [
        247, #这个是平均值
        4,
        '具有一定价值的刺儿小饰品！使用/use 刺儿饰品即可卖出此物品\n使用/use 刺儿饰品/数量可批量卖出此物品'
    ]
}

#今日物品，前期道具较少，采用固定商品固定数量
today_item = {'刺儿加工器': 500, '指南针': 500, '神秘碎片': 500, '时间秒表': 50, '胡萝卜': 50, '招财猫': 100, '一次性小手枪': 100, '弹弓': 100, 'kid充能器': 500, 'kid提取器': 50,'时间提取器':500,'赌徒之眼':200}