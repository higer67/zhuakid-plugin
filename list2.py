...
kid_data2 = {
    '1':{
        '1':{
            'name': '马赛克kid',
            'description':
            '这只kid不喜欢真人出镜，于是他要求猎场管理员给他打了一层马赛克'
        },
        '2':{
            'name': '玩具球',
            'description':
        ...
        '7':{
            'name': '矿工kid',
            'description':
            '“这是石吗？”\n“这不是石！这是我刚挖出来的神金！看吧，可好看了”'
        },
        '8':{
            'name': 'tas player kid',
            'description':
            '可恶，这个kid太灵活了，什么方法都对他无效。但是无缝才是唯一真神',
            'gif': True
        },
        '9':{
            'name': '思考kid',
            'description':
            '被抓走的kid们是不是都被卖掉了？如果是的话，那我值多少钱呢？'
        },
        '10':{
            'name': 'po kid',
            'description':
    ...
    '2':{
        '1':{
            'name': '蓝鸟',
            'description':
            '只是一只又会叫又会飞还难抓，并且 另一个你 不帮忙抓的一只鸟罢了（她最坏了）',
            'gif': True      
        },
        '2':{
            'name': '小丑kid',
        ...
        '3':{
            'name': '灰尘草莓',
            'description':
            '不知道为什么，许多人都把灰尘草莓叫成煤球草莓，可能是因为隔壁的灰尘精灵长得太像煤球了',
            'gif': True 
        },
        '4':{
            'name': '星之卡比kid',
            'description':
            '星之卡比kid最后悔的事情就是吸了kid，由于星之卡比世界不存在save，他现在得一命通关星之卡比'
        },
        '5':{
            'name': '赤红kid',
            'description':
            '此kid登场于《I wanna catch pokemon》,大家和赤红kid一起努力，成为宝可梦训练大师吧！！'
        },
        '6':{
            'name': '持枪kid',
            'description':
        ...
        '7':{
            'name': '吉他手kid',
            'description':
            'kid正在用电吉他创造出一首伟大的歌曲，当然这个过程是漫长的',
            'gif': True
        },
        '8':{
            'name': '靖尊kid',
            'description':
            '哎我真的是服了，天天被玩家操控，天天死上万次，那些I Wanna作者能不能消停点啊。玩家发灰食物还会被大明星派来的黑粉质疑，然后玩家赖到我头上，我何德何能啊。小问题，下次再写小作文了。'
        },
        '9':{
            'name': '天使kid',
            'description':
            '天使的头上其实有一圈只有聪明人才能看见的光环'
        },
        '10':{
            'name': '白kid',
            'description':
    ...
    '4':{
        ...
        '2':{
            'name': 'evil',
            'description':
            '常年看邪牛的人大多目光炯炯有神，非常自信，且智商逐年上升，最后完全成为天才。看邪牛会改善身体结构，预防各种疾病。人一旦开始看邪牛就说明这个人的智慧品行样貌通通都是上等，这辈子都能在任何地方风姿飒爽。常年看邪牛的人具有强烈的社会正义感，对治安稳定有巨大的贡献，保护普通人的生命。',
            'gif': True
        },
        '3':{
            'name': 'neuro',
            'description':
            '爱钱的龟🐢，好涩的狐🦊，白色的牛⚪，黑色的牛⚫，神经的蜂🐝，神经的蜂🐝，神经的蜂🐝，神经的蜂🐝，神经的蜂🐝\n还等什么？赶快加入神经大人伟大的蜂群吧！\nheart❤',
            'gif': True
        },
        '4':{
            'name': '雾雨魔理沙kid',
            'description':
            '雾雨魔理沙kid的偶像是魔理沙，因此，他常常学习魔理沙处事的方法，这套衣服就是他刚从魔理沙家中偷来的'
        },
        '5':{
            'name': '博丽灵梦kid',
            'description':
            'Kid捡到了一套废弃的巫女服，他现在正在tho上cos博丽灵梦\n对了，这个Kid刚才被绀珠传L难度暴打过'
        },
        '6':{
            'name': 'madeline',
            'description':
    ...
    '5':{
        '1':{
            'name': 'tgdr',
            'description':
            'tgdr将自己用过的形象miku和chara融合在一起，并在衣服上缝了他的专属代号“ω”，成为他真正的形象。哦，其实他还为其取了个更响亮的名字：ku cha。看样子他真的很喜欢玩拼音梗。'      
        },
        '2':{
            'name': '冬天豆kid',
            'description':
        ...
        '10':{
            'name': '狙哥',
            'description':
            'TA是赌场最神秘的存在，传说有好赌之徒企图在赌局中捞便宜的时候，他只要悄悄扣动扳机，报幕便说“TA获得了XX的五级一个”。快准狠是TA的基本修养，因此赌场有很多人都畏惧TA的存在。很多人都好奇为什么TA每次进赌局都能全身而退，答案很简单，因为TA穷的只剩刺儿了。'           
        },
        '11':{
            'name': '白墨',
            'description':
            '因亵渎神明而被流放的天使，被击碎的光环是屈辱的证明。\n被流放的天使大都会在不久后化为虚无，但是他奇迹般地一直存活到现在。\n或许这正合他意？'             
        }
    }
}